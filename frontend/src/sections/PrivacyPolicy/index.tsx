  ...
  return (
    ...
    >
      ...
      >
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              &quot;Our&quot; in this Agreement) refers to Giftalia.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Giftalia, accessible from{' '}
              <a href="https://app.giftalia.ai/" rel="external nofollow noopener" target="_blank">
                https://app.giftalia.ai/
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>By email: giftzaza108@gmail.com</li>
        </ul>
        <Box width={'90%'} mb={2}>
          <Button
            variant="contained"
