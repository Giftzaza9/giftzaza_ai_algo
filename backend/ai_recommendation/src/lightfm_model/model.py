...
class LightFM_cls:
    ...
    def cold_start_similar_items(self,filter_dict,hard_filter_attrs,soft_filter_attrs,Global_Obj,N=10,min_budget=0,max_budget=None,test_sample_flag=False,explicit_filters=None):
        ...
        filter_item_df['embedding_tags'] = filter_item_df['embedding_tags'].apply(lambda eachlist : eachlist if isinstance(eachlist,np.ndarray) else np.full(self.model.no_components,0.000001))
